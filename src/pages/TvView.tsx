    ...
    if (error || !race) {
        return (
            <div
                ...
                <Link to="/" style={{ color: '#60a5fa', fontSize: 16 }}>
                    &lt; Vissza
                </Link>
            </div>
        );
            ...
            <aside
                ...
                <div
                    ...
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
                        ...
                        <span style={{ fontSize: 'clamp(20px, 1.7vw, 40px)', color: '#6b7280' }}>/ {race.team_target.toFixed(0)} km</span>
                    </div>
...
function TvEventTimer({ raceStartAt, raceEndAt }: { raceStartAt: string | null; raceEndAt: string | null }) {
    ...
    const color = phase === 'before' ? '#a5b4fc' : phase === 'running' ? '#22c55e' : phase === 'after' ? '#f59e0b' : '#6b7280';
